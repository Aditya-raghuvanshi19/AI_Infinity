    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="assets/user.jpeg" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/model.png" alt="Gemini avatar">
...
const displayLoadingAnimation = () => {
    const loadingHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="assets/model.png" alt="model avatar">
            <p class="message__text"></p>
